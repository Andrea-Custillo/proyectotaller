        ...
        <div class="col-12 col-lg-8 offset-0  offset-lg-2">
            <div class = " table-responsive">
                <table  class ="table table-bordered table-hover">
                    <thead><tr><th>#</th><th>MATERIAS</th><th>EDITAR</th><th>ELIMINAR</th></tr></thead>
        ...
        <div class = "modal-dialog">
            <div class ="modal-content">
                    <div class="modal-header">
                        <label class ="h5" id="titulo_modal">Añadir Materia</label>
                        <button type="button" class ="btn-close" data-bs-dismiss="modal" aria-label="close"></button>
                    </div>    
                    <div class ="modal-body">
                    <form  id= "frmmaterias" method="POST" action="{{url('materias')}}">
                        @csrf

                        <div class = "imput-group mb-3">
                            <span class ="input-group-text"><i class ="fa-solid fa-graduation-cap"></i></span>
                            <input type="text" name ="materia" class ="form-control " maxlength="50" placeholder="materia" required >
                        </div>
