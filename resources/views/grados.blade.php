        ...
        <div class="col-12 col-lg-8 offset-0  offset-lg-2">
            <div class = " table-responsive">
                <table  class ="table table-bordered table-hover">
                    <thead><tr><th>#</th><th>GRADOS</th><th>EDITAR</th><th>ELIMINAR</th></tr></thead>
        ...
        <div class = "modal-dialog">
            <div class ="modal-content">
                    <div class="modal-header">
                        <label class ="h5" id="titulo_modal">Añadir Grado</label>
                    ...
                    <form  id= "frmgrados" method="POST" action="{{url('grados')}}">
                        ...
                        <div class = "imput-group mb-3">
                            ...
                            <input type="text" name ="grado" class ="form-control " maxlength="50" placeholder="grado" required >
                        </div>
